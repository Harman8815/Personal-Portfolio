      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div className="bg-slate-900/40 backdrop-blur-2xl border border-white/10 p-4 rounded-xl shadow-2xl w-64">
                <div className="flex items-center gap-3 mb-3">
                  <div
                    className="w-10 h-10 rounded-full overflow-hidden border-2 border-white/30 flex items-center justify-center"
